...
const LinkedinQuickParseComponent = () => {
  ...
  const collectSimpleProfile = useCallback(async () => {
    ...
    try {
      ...
      const res = await chrome.tabs.sendMessage(tab.id, {
        action: 'parseSimpleLinkedinProfile',
        url: tab.url,
      })
...
export const LinkedinQuickParse = withAvailableInUrl({
  url: String.raw`^https:\/\/www\.linkedin\.com\/in\/[a-zA-Z0-9-]+\/?$`,
})(LinkedinQuickParseComponent)
