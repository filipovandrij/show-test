...
import { LinkAnalyzer } from '../../../chrome/findCandidatesState'
...
const MatchHistory = () => {
  const findCandidatesListFromBg = useAppStateSelector((state) => state.linkAnalyzer)
    ...
    <>
      ...
      <Content>
        ...
        {findCandidatesList.map(({ name, date }, i) => (
          <Command onClick={() => navigate(`/match-ai-link-analyzer/${i}`)}>
            <ChatIcon />
